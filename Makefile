#############################################################################
# Makefile for building: asciireadwrite2
# Generated by qmake (3.0) (Qt 5.1.0) on: Sat Feb 8 20:36:26 2014
# Project:  asciireadwrite2.pro
# Template: app
# Command: /home/richard/Qt5.1.0/5.1.0/gcc_64/bin/qmake -spec linux-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile asciireadwrite2.pro
#############################################################################
...
CXXFLAGS      = -pipe -gdwarf-3 -g -O0 -std=c++0x -Wparentheses -Wreturn-type -Wshadow -Wextra -Wunused-parameter -Weffc++ -Wall -W -fPIE $(DEFINES)
INCPATH       = -I../../../Qt5.1.0/5.1.0/gcc_64/mkspecs/linux-g++ -I. -Isrc -Isrc/binrw -Isrc/txtrw -Isrc/hstring
LINK          = g++
...
DIST          = ../../../Qt5.1.0/5.1.0/gcc_64/mkspecs/features/spec_pre.prf \
		...
		asciireadwrite2.pro \
		asciireadwrite2.pro
QMAKE_TARGET  = asciireadwrite2
DESTDIR       = #avoid trailing-slash linebreak
TARGET        = asciireadwrite2
...
Makefile: asciireadwrite2.pro ../../../Qt5.1.0/5.1.0/gcc_64/mkspecs/linux-g++/qmake.conf ../../../Qt5.1.0/5.1.0/gcc_64/mkspecs/features/spec_pre.prf \
		../../../Qt5.1.0/5.1.0/gcc_64/mkspecs/common/shell-unix.conf \
		../../../Qt5.1.0/5.1.0/gcc_64/mkspecs/common/unix.conf \
		../../../Qt5.1.0/5.1.0/gcc_64/mkspecs/common/linux.conf \
		../../../Qt5.1.0/5.1.0/gcc_64/mkspecs/common/gcc-base.conf \
		...
		../../../Qt5.1.0/5.1.0/gcc_64/mkspecs/features/lex.prf \
		asciireadwrite2.pro
	$(QMAKE) -spec linux-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile asciireadwrite2.pro
...
dist: 
	@test -d .tmp/asciireadwrite21.0.0 || mkdir -p .tmp/asciireadwrite21.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/asciireadwrite21.0.0/ && (cd `dirname .tmp/asciireadwrite21.0.0` && $(TAR) asciireadwrite21.0.0.tar asciireadwrite21.0.0 && $(COMPRESS) asciireadwrite21.0.0.tar) && $(MOVE) `dirname .tmp/asciireadwrite21.0.0`/asciireadwrite21.0.0.tar.gz . && $(DEL_FILE) -r .tmp/asciireadwrite21.0.0
...
.tmp/main.o: src/main.cpp src/test.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o .tmp/main.o src/main.cpp

.tmp/test.o: src/test.cpp src/hstring/stringhelper.h \
		src/binrw/rBin.h \
		src/helper.h \
		src/txtrw/rList.h \
		src/txtrw/wList.h \
		src/binrw/wBin.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o .tmp/test.o src/test.cpp
