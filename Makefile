...
# Template: app
# Command: /home/richard/Qt5.3.0/5.3/gcc_64/bin/qmake -spec linux-g++ CONFIG+=debug -o Makefile asciireadwrite2.pro
#############################################################################
...
INCPATH       = -I../../../Qt5.3.0/5.3/gcc_64/mkspecs/linux-g++ -I. -Isrc -Isrc/binrw -Isrc/txtrw -Isrc/hstring
LINK          = g++
...
DIST          = ../../../Qt5.3.0/5.3/gcc_64/mkspecs/features/spec_pre.prf \
		...
		asciireadwrite2.pro src/main.cpp \
		src/test.cpp \
		src/hstring/gettokens.cpp \
		src/hstring/stringhelper.cpp
...
Makefile: asciireadwrite2.pro ../../../Qt5.3.0/5.3/gcc_64/mkspecs/linux-g++/qmake.conf ../../../Qt5.3.0/5.3/gcc_64/mkspecs/features/spec_pre.prf \
		../../../Qt5.3.0/5.3/gcc_64/mkspecs/common/shell-unix.conf \
		../../../Qt5.3.0/5.3/gcc_64/mkspecs/common/unix.conf \
		../../../Qt5.3.0/5.3/gcc_64/mkspecs/common/linux.conf \
		../../../Qt5.3.0/5.3/gcc_64/mkspecs/common/gcc-base.conf \
		...
		../../../Qt5.3.0/5.3/gcc_64/mkspecs/features/lex.prf \
		asciireadwrite2.pro
	$(QMAKE) -spec linux-g++ CONFIG+=debug -o Makefile asciireadwrite2.pro
...
dist: 
	...
	$(COPY_FILE) --parents $(DIST) .tmp/asciireadwrite21.0.0/ && (cd `dirname .tmp/asciireadwrite21.0.0` && $(TAR) asciireadwrite21.0.0.tar asciireadwrite21.0.0 && $(COMPRESS) asciireadwrite21.0.0.tar) && $(MOVE) `dirname .tmp/asciireadwrite21.0.0`/asciireadwrite21.0.0.tar.gz . && $(DEL_FILE) -r .tmp/asciireadwrite21.0.0
